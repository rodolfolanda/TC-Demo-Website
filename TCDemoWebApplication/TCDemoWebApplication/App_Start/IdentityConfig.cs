...
using TCDemoWebApplication;
using TCDemoWebApplication.Models;

namespace TCDemoWebApplication
{
...
namespace Microsoft.AspNet.Identity 
{
    public static class IdentityExtensions 
    {
        ...
        public static string GetUserId(this IIdentity identity) 
        {
            ...
            if (ci != null) 
            {
                return ci.FindFirstValue(TCDemoWebApplication.IdentityConfig.UserIdClaimType);
            }
            return String.Empty;
        }
